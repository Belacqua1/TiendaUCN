    ...
    public class DataSeeder
    {
        ...
        public static async Task Initialize(IServiceProvider serviceProvider)
        {
            try
            {
                ...
                var genders = configuration.GetSection("User:Gender").Get<string[]>() ?? throw new InvalidOperationException("La configuración de genero no está completa");
                ...
                if (!await context.Users.AnyAsync())
                {
                    ...
                    User adminUser = new User
                    {
                        ...
                        EmailConfirmed = true,
                        Gender = configuration["User:AdminUser:Gender"]?? throw new InvalidDataException("El Genero del usuario administrador no está configurado."),
